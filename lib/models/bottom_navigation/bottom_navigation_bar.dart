...
class _BottomNavigationBarViewState extends State<BottomNavigationBarView> {
  ...
  static final List<Widget> _widgetOptions = <Widget>[
     const Text('Courses', style: optionStyle),
    ProjectView(),
     const HomeScreen(),
     const CaseStudyView(),
                  ...
                  tabs: [
                    GButton(
                      ...
                      leading: SvgPicture.asset(
                        ...
                        width: 24,
                        height: 24,
                        color: _selectedIndex == 0 ? AppColors.whiteColor  : AppColors.blackColor,
                      ),
                    ),
                    GButton(
                      backgroundColor: AppColors.primarySkyColor,
                      ...
                      leading: SvgPicture.asset(
                        ...
                        width: 24,
                        height: 24,
                        color: _selectedIndex == 1 ? AppColors.whiteColor  :AppColors.blackColor,
                      ),
                    ),
                    GButton(
                      backgroundColor: AppColors.primarySkyColor,
                      ...
                      leading: SvgPicture.asset(
                        ...
                        width: 24,
                        height: 24,
                        color: _selectedIndex == 2 ? AppColors.whiteColor  : AppColors.blackColor,
                      ),
                    ),
                    GButton(
                      backgroundColor: AppColors.primarySkyColor,
                      ...
                      leading: SvgPicture.asset(
                        ...
                        width: 24,
                        height: 24,
                        color: _selectedIndex == 3 ? AppColors.whiteColor  :AppColors.blackColor,
                      ),
                    ),
                    GButton(
                      backgroundColor: AppColors.primarySkyColor,
                      ...
                      leading: SvgPicture.asset(
                        ...
                        width: 24,
                        height: 24,
                        color: _selectedIndex == 4 ? AppColors.whiteColor : AppColors.blackColor,
                      ),
                    ),
                  ],
